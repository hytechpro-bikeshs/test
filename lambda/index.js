...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, you can say Hello or Help. Now you can search property from HART.';
...
const TestAPICallIntentHandler = {
   ...
   async handle(handlerInput) {
        ...
        {   const speakOutput = 'Welcome in Home Connection HART Partner, Test API Call Intent Called. API Called and data recieved. '+handlerInput.session.sessionId;       
            return handlerInput.responseBuilder
                .speak(speakOutput)
                //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
                .getResponse(); 
        ...
        {
          const speakOutput = 'Welcome in Home Connection HART Partner, nothing recieve from API.';       
            return handlerInput.responseBuilder
                .speak(speakOutput)
                //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
                .getResponse(); 
